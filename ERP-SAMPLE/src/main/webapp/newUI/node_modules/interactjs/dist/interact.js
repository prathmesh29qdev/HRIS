...
(function(f) {
	...
	_$window_84.window = _$window_84.realWindow = void 0;
	/* removed: var _$isWindow_77 = require("./isWindow.js"); */

	;
	var realWindow = undefined;
	_$window_84.realWindow = realWindow;
	var win = undefined;
	_$window_84.window = win;

	function init(window) {
		// get wrapped window if using Shadow DOM polyfill
		_$window_84.realWindow = realWindow = window; // create a TextNode
	...
	var __window_76 = function window(thing) {
		return thing === _$window_84.window || (0, _$isWindow_77["default"])(thing);
	};
	...
	var element = function element(thing) {
		...
		var _window = _$window_84.getWindow(thing) || _$window_84.window;
	...
	function __init_67(window) {
		...
		var navigator = _$window_84.window.navigator; // Does the browser support touch input?
	...
	function matchesSelector(element, selector) {
		...
		if (_$window_84.window !== _$window_84.realWindow) {
	...
	function zIndexIsHigherThan(higherNode, lowerNode) {
		var higherIndex = parseInt(_$window_84.getWindow(higherNode).getComputedStyle(higherNode).zIndex, 10) || 0;
		var lowerIndex = parseInt(_$window_84.getWindow(lowerNode).getComputedStyle(lowerNode).zIndex, 10) || 0;
	...
	function getScrollXY(relevantWindow) {
		relevantWindow = relevantWindow || _$window_84.window;
		return {
	...
	function getElementRect(element) {
		...
		if (!_$browser_67["default"].isIOS7 && clientRect) {
			var scroll = getScrollXY(_$window_84.getWindow(element));
	...
	_$BaseEvent_15.BaseEvent = void 0;
	...
	function warnOnce(method, message) {
		...
		return function() {
			if (!warned) {
				_$window_84.window.console.warn(message);
	...
	function hasStyle(element, prop, styleRe) {
		var value = element.style[prop] || _$window_84.window.getComputedStyle(element)[prop];
		...
		function InteractableSet(scope) {
			...
			scope.addListeners({
				'interactable:unset': function interactableUnset(_ref) {
					...
					var targetIndex = _$arr_66.findIndex(targetMappings, function(m) {
	...
	var Scope = /*#__PURE__*/function() {
		...
		___createClass_29(Scope, [{
			...
			value: function addDocument(doc, options) {
				...
				var window = _$window_84.getWindow(doc);
	...
	function startReflow(scope, interactable, element, action, event) {
		...
		_$pointerUtils_81.setZeroCoords(interaction.coords.delta);
